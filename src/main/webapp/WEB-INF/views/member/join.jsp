...
<div class="container">
   <div class="text-center">
    <div class="box box-primary">
      ...
      <div class="form-group row">
        <label for="dark_password2" class="col-2">비밀번호 확인</label>
        <div class="col-10">
          <input type="password" class="form-control" id="dark_password2" placeholder="비밀번호 확인...">
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-8">
          <input type="text" class="form-control" name="dark_zipcode" id="sample2_postcode" placeholder="우편번호...">
        </div>
        <div class="col-2">
  ...
  $("#idCheck").click(function() {
    ...
    if($("#dark_id").val() == "") {
      ...
      $.ajax({
        ...
        type: 'get',
        datatype: 'text',
        data: {dark_id : $("#dark_id").val()},
        success: function(result) {
          if(result == "yes") { // 컨트롤러로 의 /member/idCheck 매핑주소로부터 "yes" 라는 응답을 받아와 동작. 
            alert("아이디 사용가능");
            useIDCheck = true;
          }else {
            alert("사용 불가능");
            useIDCheck = false;
            $("#dark_id").val(""); // 아이디 텍스트박스 비우기
            $("#dark_id").focus();
   ...
   $("#btnConfirmAuth").click(function() {
     ...
     $("#btnJoin").click(function() {
      ...
      if($("#dark_password").val() != $("#dark_password2").val()) {
