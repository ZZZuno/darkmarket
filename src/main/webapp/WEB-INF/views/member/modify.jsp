   ...
   <div class="text-center">
    <div class="box box-primary">
      ...
      <div class="form-group row">
        ...
        <div class="col-8">
          <input type="email" class="form-control" name="dark_email" id="dark_email" value="${memberVO.dark_email }" placeholder="전자우편입력...">
        </div>
        <div class="col-2">
      ...
      <div class="form-group row">
        <label for="dark_id" class="col-2">메일인증</label>
        <div class="col-8">
      ...
      <div class="form-group row">
        ...
        <div class="col-8">
          <input type="text" class="form-control" name="dark_zipcode" id="sample2_postcode" value="${memberVO.dark_zipcode}" placeholder="우편번호...">
        </div>
        <div class="col-2">
      ...
      <div class="form-group row">
        ...
        <div class="col-10">
          <input type="text" class="form-control" name="dark_addr" id="sample2_address" value="${memberVO.dark_addr}" placeholder="기본주소입력...">
        </div>
      </div>
      <div class="form-group row">
        <label for="sample2_detailAddress" class="col-2">상세주소</label>
        <div class="col-10">
          <input type="text" class="form-control" name="dark_deaddr" id="sample2_detailAddress" value="${memberVO.dark_deaddr}" placeholder="상세주소입력...">
      ...
      <div class="form-group row">
        ...
        <div class="col-10">
          <input type="text" class="form-control" name="dark_phone" id="dark_phone" value="${memberVO.dark_phone }" placeholder="전화번호입력...">
        </div>
      </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    // form 태그참조. <form role="form" id="modifyForm" method="post" action="">
