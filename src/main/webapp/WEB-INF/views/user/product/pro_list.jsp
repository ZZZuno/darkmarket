  ...
  <div class="col-md-3">
     <div class="col-md-4">
          <div class="card mb-4 shadow-sm">
            <img class="btn_pro_img" style="cursor: pointer" width="100%" height="200" data-pro_num = "${productVO.pro_num}" src="/user/product/imageDisplay?dateFolderName=${productVO.pro_up_folder }&fileName=${productVO.pro_img }">
            <div class="card-body">
