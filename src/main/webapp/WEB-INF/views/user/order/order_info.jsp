...
<div class="container">
  ...
  <div class="box box-primary">
      ...
      <div class="form-group row">
        ...
        <div class="col-10">
          <input type="text" class="form-control" id="mbsp_id" value="${loginStatus.dark_id }" readonly>
        </div>
      </div>
      <div class="form-group row">
        <label for="mbsp_name" class="col-2">이름</label>
        <div class="col-10">
          <input type="text" class="form-control" id="b_mbsp_name" value="${loginStatus.dark_name }" readonly>
        </div>
      </div>
      <div class="form-group row">
        <label for="mbsp_email" class="col-2">전자우편</label>
        <div class="col-8">
          <input type="email" class="form-control" id="b_mbsp_email" value="${loginStatus.dark_email }" readonly>
        </div>
      </div>
      <div class="form-group row">
        <label for="sample2_postcode" class="col-2">우편번호</label>
        <div class="col-8">
          <input type="text" class="form-control" id="b_mbsp_zipcode" value="${loginStatus.dark_zipcode }" readonly>
        </div>
      </div>
      <div class="form-group row">
        <label for="sample2_address" class="col-2">기본주소</label>
        <div class="col-10">
          <input type="text" class="form-control" id="b_mbsp_addr" value="${loginStatus.dark_addr }" readonly>
        </div>
      </div>
      <div class="form-group row">
        <label for="sample2_detailAddress" class="col-2">상세주소</label>
        <div class="col-10">
          <input type="text" class="form-control" id="b_mbsp_deaddr" value="${loginStatus.dark_deaddr }" readonly>
        </div>
      </div>
      <div class="form-group row">
        <label for="mbsp_phone" class="col-2">전화번호</label>
        <div class="col-10">
          <input type="text" class="form-control" id="b_mbsp_phone" value="${loginStatus.dark_phone }" readonly>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-2">
        	<input type="checkbox" id="same">주문인과 동일
        </div>
      </div>
      <div class="form-group row">
        <label for="sample2_postcode" class="col-2">우편번호</label>
      ...
      <div class="form-group row">
        ...
        <div class="col-10">
          ...
          <input type="radio" name="paymethod" id="paymethod2" value="kakaopay"><img src="/image/payment.png"><br>
        </div>
      </div>
      <div class="form-group row" id="nobank_info" style="display: none;">
        <label for="mbsp_phone" class="col-2">무통장입금 정보</label>
        <div class="col-10">
          은행명
...
<script>
  ...
  $("#same").on("click", function() {
    ...
    $("#btn_order").on("click", function() {
      ...
      // console.log("ord_price", $("#cart_total_price").text());  // span태그는 입력양식태그가 아니기 때문에 val() 메소드 사용 불가.
      // console.log("totalprice", $("#cart_total_price").text()); // span태그는 입력양식태그가 아니기 때문에 val() 메소드 사용 불가.
      ...
      $.ajax({
        ...
        type: 'get',
        data: {
          paymethod : $("input[name='paymethod']:checked").val(),  // input type="radio" 태그이기 때문에 :selected를 넣어줘야함.
