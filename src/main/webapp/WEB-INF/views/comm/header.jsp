...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
  <h5 class="my-0 mr-5 font-weight-normal"><a href="/">DarkMarket</a></h5>
  <h6 class="my-0 mr-md-auto font-weight-normal"><a href="/board/list" style="color: black;">공지사항</a></h6>
  ...
  <nav class="my-2 my-md-0 mr-md-3">
    ...
    <a class="p-2 text-dark" href="/user/order/order_list">Order</a>
